...
%try   
    ...
    % save('/scratch/shaws5/Research_data/Analyzed_data/pli_function_custom_workspace','-v7.3');
    parfor sub = 1:freq_number % Iterate through the different frequency bands
        % sub
