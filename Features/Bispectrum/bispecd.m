function [Bspec,waxis] = bispecd (y,  nfft, wind, nsamp, overlap, plot_bispec)
...
%   plot_bispec - 0|1 If you want to generate contour plot of the bispectrum
%
...
% --------------------- parameter checks -----------------------------
    ...
    if (exist('plot_bispec') ~= 1)    plot_bispec = 0; end
    if (nrecs == 1 & nsamp <= 0)
