...
if any(runFeatureComputation)
    ...
    if compute_BPow [bandPower_features] = EEG_band_powers(EEG.data, EEG.srate); save([curr_dir filesep 'EEG_Features' filesep 'Rev_' dataset_name '_AllEpochs_' 'BandPowers'],'bandPower_features'); end
