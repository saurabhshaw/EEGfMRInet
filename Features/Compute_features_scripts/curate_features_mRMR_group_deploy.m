function curate_features_mRMR_group_deploy(input_mat)
...
save([output_base_path_data filesep 'Analyzed_data' filesep 'GroupResults_' study_name filesep study_name '_' currFeatures_curated{i} '_mRMRiterateGroupResults_' CONN_cfg.class_types name_suffix],'final_dataset_mRMR','final_feature_labels_mRMR','curr_labels_mRMR','curr_dataset_mRMR_IDX','currFeatures_curated','nestedFeature_struct','-v7.3');
