...
function curate_features_mRMR_group_LOOP_deploy(i,Featurefiles_directory_ALL,curr_Featurefiles_basename_ALL,YY_final_ALL,name_suffix,output_base_path_data,study_name,max_features,CONN_cfg,varargin)
...
if length(feat_file_Feature_size) == 4 % Single Frequency Computation
    ...
    parfor m = 1:feat_file_Feature_size(1) % Number of Windows = WAS PARFOR
        ...
        for n = 1:feat_file_Feature_size(2) % Number of Frequency Windows
            ...
            [elec_output_features{n}, elec_output_scores{n},elec_dataset_mRMR,elec_feature_labels_mRMR] = mRMR_iterate_loop(curr_dataset_mRMR,curr_labels_mRMR_final,innermost_feature_size,max_features,elec_dataset_mRMR,elec_feature_labels_mRMR);
        ...
        [freq_output_features{m}, freq_output_scores{m},freq_dataset_mRMR{m},freq_feature_labels_mRMR{m}] = mRMR_iterate_loop(elec_dataset_mRMR,curr_labels_mRMR_final,curr_feature_size,max_features,freq_dataset_mRMR{m},freq_feature_labels_mRMR{m},elec_feature_labels_mRMR);
    ...
    for m = 1:feat_file_Feature_size(1) % Number of Windows
        ...
        parfor n = 1:(feat_file_Feature_size(2)-1) % Number of Frequency Windows
            ...
            for p = 1:feat_file_Feature_size(3)
                ...
                if n < p % This is how features were computed for cross-frequency features
                    ...
                    % Run mRMR at this level:
                    [innerFreq_output_features{p}, innerFreq_output_scores{p},innerFreq_dataset_mRMR,innerFreq_feature_labels_mRMR] = mRMR_iterate_loop(curr_dataset_mRMR,curr_labels_mRMR_final,innermost_feature_size,max_features,innerFreq_dataset_mRMR,innerFreq_feature_labels_mRMR);
            ...
            [elec_output_features{n}, elec_output_scores{n},elec_dataset_mRMR{n},elec_feature_labels_mRMR{n}] = mRMR_iterate_loop(innerFreq_dataset_mRMR,curr_labels_mRMR_final,curr_feature_size,max_features,elec_dataset_mRMR{n},elec_feature_labels_mRMR{n},innerFreq_feature_labels_mRMR,innerFreq_loopIDX_mRMR);
        ...
        elec_feature_labels_mRMR = cat(2,elec_feature_labels_mRMR{:});
        curr_feature_size = [feat_file_Feature_size(2) size(elec_output_features{1},2)];
        [freq_output_features{m}, freq_output_scores{m},freq_dataset_mRMR,freq_feature_labels_mRMR] = mRMR_iterate_loop(elec_dataset_mRMR,curr_labels_mRMR_final,curr_feature_size,max_features,freq_dataset_mRMR,freq_feature_labels_mRMR,elec_feature_labels_mRMR,elec_loopIDX_mRMR);
...
[wind_output_features{i}, wind_output_scores{i},wind_dataset_mRMR,wind_feature_labels_mRMR] = mRMR_iterate_loop(freq_dataset_mRMR,curr_labels_mRMR_final,curr_feature_size,max_features,wind_dataset_mRMR,wind_feature_labels_mRMR,freq_feature_labels_mRMR);
