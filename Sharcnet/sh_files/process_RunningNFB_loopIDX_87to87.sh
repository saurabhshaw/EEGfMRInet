...
#SBATCH --output=/home/shaws5/projects/def-beckers/shaws5/Research_code/EEGnet/Sharcnet/out_files/process_RunningNFB_loopIDX_87to87-Node%N-JobID%j.out  # %N for node name, %j for jobID
