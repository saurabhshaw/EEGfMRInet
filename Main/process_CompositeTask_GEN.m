                        ...
                        if ~isempty(dir([Featurefiles_directory filesep Featurefiles_basename '_ClassificationResults' name_suffix '_FEAT' final_featuresToUse '_CLASS' CONN_cfg.class_types '.mat'])) && ~redo_classification
                            ...
                            switch final_featuresToUse
                                case 'individual'
                                    ...
                                    if ~missing_curate_featues_mRMR % REMOVE THIS LATER
                                ...
                                case 'preselected'
                                    ...
                                    if isempty(dir([Featurefiles_directory filesep Featurefiles_basename '_FeaturesAllTrialsGEN.mat']))
                                        tic; [Features] = get_selected_features(curr_model, Featurefiles_basename, Featurefiles_directory, run_matfile); toc;
                                        % selectedFeatures_results = load([Featurefiles_directory filesep Featurefiles_basename '_FeaturesGEN.mat']);
                                        % Features = selectedFeatures_results.Features_SUB{m};
                                        % YY_final = selectedFeatures_results.YY_final_SUB{m};
                                        % YY_final_continuous = selectedFeatures_results.YY_final_continuous_SUB{m};
                                        save([Featurefiles_directory filesep Featurefiles_basename '_FeaturesAllTrialsGEN'],'Features','YY_final','YY_final_continuous');
                                    else
