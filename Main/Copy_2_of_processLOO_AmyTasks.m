...
for current_test_block = 2:length(sub_dir)
    ...
    parfor kk = 1:num_CV_folds_per_pt % make this par
        ...
        [TrainAccuracy_SUB(current_test_block,kk), TestAccuracy_SUB(current_test_block,kk), Model_SUB{current_test_block,kk}] = classify_SVMweighted_libsvm(curr_Features_classify(:,Features_ranked_mRMR_SUB),curr_YY_final_classify','RBF',0,class_weights,trainIdx_SUB,testIdx_SUB);
        ...
        [TrainAccuracy_null_SUB(current_test_block,kk), TestAccuracy_null_SUB(current_test_block,kk), Model_null_SUB{current_test_block,kk}] = classify_SVMweighted_libsvm(curr_Features_classify(:,Features_ranked_mRMR_SUB),Y_null','RBF',0,class_weights,trainIdx_SUB,testIdx_SUB);
    end
