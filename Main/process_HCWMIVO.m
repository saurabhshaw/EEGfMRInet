        ...
        for jj = 1:length(conditions)
            ...
            % try %dmer1
                ...
                if ~skip_analysis
                    ...
                    % 
                    %     TR_window_step = CONN_cfg.window_step/scan_param.TR; % The window_step in units of TR
                    %     TR_window_length = CONN_cfg.window_length/scan_param.TR; % The window_length in units of TR
                    % 
