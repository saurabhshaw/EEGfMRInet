...
% sub_dir = [1];
%% For Loop:
for ii = 42:length(sub_dir) % GRAHAM_PARFOR
    for jj = 1:length(runs_to_include)        
        try
            ...
            if ~skip_analysis
                ...
                % Get the feature number of windows
                if run_matfile
                ...
                for i = sort(features_to_include)
                    ...
                    % curr_Features = cat(2,curr_Features,curr_Features_struct.final_dataset_mRMR);
                ...
                % Scale the current window number of windows
                if run_matfile
                ...
                % Find the mapping from feature labels to current features:
                ...
                %                 curr_Features = cell(1,length(curr_sess_IDX));
%                 tic
...
% Gather the data for everything:
