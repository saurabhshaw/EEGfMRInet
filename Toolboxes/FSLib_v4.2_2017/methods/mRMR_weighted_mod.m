function [fea, score] = Copy_of_mRMR_weighted(X_train, Y_train, weights, K)
...
for k=2:K
    ...
    for i=1:ncand
        ...
        mi_array(idxleft(i),curlastfea) = WeightedMIToolboxMex(4, weights, X_train(:,fea(curlastfea)), X_train(:,idxleft(i)));
