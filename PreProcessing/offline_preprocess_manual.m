% function offline_preprocess_manual(cfg,curr_dir,dataset_name,EEG)
...
if isempty(dir(stageCompletion_file))
...
if max_finishedStage == current_stage-1
    ...
    [EEG,HP,BUR] = clean_artifacts(EEG,'ChannelCriterion',0.8,'BurstCriterion','off','WindowCriterion','off');
