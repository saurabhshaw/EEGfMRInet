function [TrainAccuracy, TestAccuracy, Model] = classify_RSVM_libsvm(X,Y,kernel,testTrainPartition,class_weights,varargin)
...
compute_posterior = 1;
optimize = 1; optimize_kernel = 0;
train_control_string = '-s 3';
